			...
			<!-- Grid row -->
				<div class="row">
				  ...
				  <div class="col-md-12 d-flex justify-content-center mb-5">
				    ...
				    <button type="button" class="btn btn-outline-light waves-effect filter" data-rel="all">Todas</button>
				    <button type="button" class="btn btn-outline-light waves-effect filter" data-rel="1">Natureza</button>
				    <button type="button" class="btn btn-outline-light waves-effect filter" data-rel="2">Lago</button>
